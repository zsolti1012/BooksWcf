...
namespace BooksHost.BooksService {
    ...
    public interface IBooksService {
        ...
        BooksWcf.Book[] ListAll(BooksWcf.User client);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBooksService/ListAll", ReplyAction="http://tempuri.org/IBooksService/ListAllResponse")]
        System.Threading.Tasks.Task<BooksWcf.Book[]> ListAllAsync(BooksWcf.User client);
        ...
        BooksWcf.Book[] ListById(string id, BooksWcf.User client);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBooksService/ListById", ReplyAction="http://tempuri.org/IBooksService/ListByIdResponse")]
        System.Threading.Tasks.Task<BooksWcf.Book[]> ListByIdAsync(string id, BooksWcf.User client);
        ...
        bool Insert(string name, string rating, string lenght, string releaseYear, BooksWcf.User client, string Header);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBooksService/Insert", ReplyAction="http://tempuri.org/IBooksService/InsertResponse")]
        System.Threading.Tasks.Task<bool> InsertAsync(string name, string rating, string lenght, string releaseYear, BooksWcf.User client, string Header);
        ...
        bool Update(string id, string name, string rating, string lenght, string releaseYear, BooksWcf.User client, string Header);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBooksService/Update", ReplyAction="http://tempuri.org/IBooksService/UpdateResponse")]
        System.Threading.Tasks.Task<bool> UpdateAsync(string id, string name, string rating, string lenght, string releaseYear, BooksWcf.User client, string Header);
        ...
        bool Delete(string id, BooksWcf.User client, string header);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBooksService/Delete", ReplyAction="http://tempuri.org/IBooksService/DeleteResponse")]
        System.Threading.Tasks.Task<bool> DeleteAsync(string id, BooksWcf.User client, string header);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IBooksServiceChannel : BooksHost.BooksService.IBooksService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class BooksServiceClient : System.ServiceModel.ClientBase<BooksHost.BooksService.IBooksService>, BooksHost.BooksService.IBooksService {
        ...
        public System.Threading.Tasks.Task<bool> InsertAsync(string name, string rating, string lenght, string releaseYear, BooksWcf.User client, string Header) {
            return base.Channel.InsertAsync(name, rating, lenght, releaseYear, client, Header);
        }
